...
fn access_control(req: &Request<&mut AsyncTcpStream>, config: &ServerConfig) -> http::Result {
...
pub async fn connection_handler(req: Request<&mut AsyncTcpStream>, config: &ServerConfig) {
